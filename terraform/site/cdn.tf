// CloudFront signs requests to the private S3 origin using OAC.
resource "aws_cloudfront_origin_access_control" "site" {
  name                              = "${var.project_name}-oac"
  description                       = "CloudFront OAC for ${var.domain_name}"
...
// Serve the static site globally through CloudFront and force HTTPS.
